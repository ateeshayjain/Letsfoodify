<?php
/**
 * Title: Shop by effort
 * Slug: foodify/shop-by-effort
 * Categories: foodify
 * Description: The three ranges, sorted by how you make them. Principle 01 — prep effort leads.
 */
?>
...
<h2 class="wp-block-heading has-2-xl-font-size">Sorted by how you make it</h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"mute","fontSize":"md","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|60"}}}} -->
<p class="has-mute-color has-text-color has-md-font-size" style="margin-bottom:var(--wp--preset--spacing--60)">Not by cuisine, not by price. The question is how much effort you have tonight.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"fontSize":"sm"} --><p class="has-sm-font-size"><a href="/product-category/express/">Shop Express →</a></p><!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"fontSize":"sm"} --><p class="has-sm-font-size"><a href="/product-category/hot-and-fresh/">Shop Hot &amp; Fresh →</a></p><!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"fontSize":"sm"} --><p class="has-sm-font-size"><a href="/product-category/flavors/">Shop Flavors →</a></p><!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
<!-- /wp:column -->
